...
export const CANAAN_CID_FAREWELL_EVENT_FLAG = "canaan_cid_farewell_complete";
export const SARA_PORTRAIT_URL = "../assets/images/portraits/portrait_sara.png";
export const CID_PORTRAIT_URL = "../assets/images/portraits/portrait_cid.png";
...
export function isCidGuestActive(envelope) {
  const flags = envelope?.save?.event_flag;
  if (!flags || typeof flags !== "object") return false;
  return Boolean(flags[KAZUS_CID_FOLLOWER_EVENT_FLAG]) && !Boolean(flags[CANAAN_CID_FAREWELL_EVENT_FLAG]);
}
