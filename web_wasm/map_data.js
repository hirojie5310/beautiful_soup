...
const MAP_MANIFEST = {
  ...
  Canaan_ArmorShop: new URL("../assets/maps/Canaan-ArmorShop.json", import.meta.url).href,
  Canaan_CidHouse_1F: new URL("../assets/maps/Canaan-CidHouse_1F.json", import.meta.url).href,
  Canaan_Inn_ItemShop: new URL("../assets/maps/Canaan-Inn_ItemShop.json", import.meta.url).href,
  Canaan_MagicShop: new URL("../assets/maps/Canaan-MagicShop.json", import.meta.url).href,
  Canaan_NobleHouse: new URL("../assets/maps/Canaan-NobleHouse.json", import.meta.url).href,
  Canaan_Shrine: new URL("../assets/maps/Canaan-Shrine.json", import.meta.url).href,
  Canaan_WeaponShop: new URL("../assets/maps/Canaan-WeaponShop.json", import.meta.url).href,
  Dragons_Peak: new URL("../assets/maps/Dragons_Peak.json", import.meta.url).href,
